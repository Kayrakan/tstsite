<template>
  <aside class="sidebar">
    <div class="side-mobile">
      ...
      <div class="tags">
        <v-chip class="use-bg-primary-light">
          Designs
        </v-chip>
        <v-chip class="use-bg-secondary-light">
          Architect
        </v-chip>
        <v-chip class="use-bg-accent-light">
          Programming
        </v-chip>
        <v-chip class="use-bg-accent2-light">
          Photography
        </v-chip>
      </div>
    </div>
    <div class="side-mobile">
      ...
      <div class="about_skills">
        <v-list bg-color="transparent" density="comfortable">
          ...
          >
            <template #prepend>
              <v-avatar class="avatar" alt="avatar" :image="item.img" title="avatar" />
            </template>
            <template #append>
