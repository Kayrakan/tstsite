          ...
          <div class="about">
            ...
            <hidden point="mdUp">
              <div class="mt-10">
                ...
                <div class="socmed">
                  <v-btn icon variant="text" small class="margin">
            ...
            <div class="photo">
              ...
              <v-card class="live-paper">
                <v-row class="spacing2 align-center mb-2">
                  <v-col cols="4">
                    <figure>
                  ...
                  <v-col cols="8">
                    <h6 class="use-text-subtitle2 font-weight-medium">
                ...
                <v-btn class="btn" block size="large" color="secondary">
                  {{ $t('avatar.btn_watch') }}
                </v-btn>
              </v-card>
            </div>
