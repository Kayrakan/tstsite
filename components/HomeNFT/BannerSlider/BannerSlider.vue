      ...
      <div class="mb-3">
        ...
        <v-list class="content-popup" tag="nav" aria-label="main mailbox folders">
          <v-list-item href="#" title="Wallet Lorem" class="wallet-list">
            <template #prepend>
              <v-avatar>
                <img :src="imgAPI.logos[1]" alt="nft card">
              </v-avatar>
            </template>
            <template #append>
          ...
          <v-list-item href="#" title="Wallet Lorem" class="wallet-list">
            <template #prepend>
              <v-avatar>
                <img :src="imgAPI.logos[2]" alt="nft card">
              </v-avatar>
            </template>
          </v-list-item>
          <v-divider />
          <v-list-item href="#" title="Wallet Lorem" class="wallet-list">
            <template #prepend>
              <v-avatar>
                <img :src="imgAPI.logos[3]" alt="nft card">
              </v-avatar>
            </template>
          </v-list-item>
          <v-divider />
          <v-list-item href="#" title="Wallet Lorem" class="wallet-list">
            <template #prepend>
              <v-avatar>
                <img :src="imgAPI.logos[11]" alt="nft card">
              </v-avatar>
            </template>
          </v-list-item>
          <v-divider />
          <v-list-item href="#" title="Wallet Lorem" class="wallet-list">
            <template #prepend>
              <v-avatar>
                <img :src="imgAPI.logos[12]" alt="nft card">
              </v-avatar>
            </template>
          </v-list-item>
          <v-divider />
          <v-list-item href="#" title="Wallet Lorem" class="wallet-list">
            <template #prepend>
              <v-avatar>
                <img :src="imgAPI.logos[21]" alt="nft card">
              </v-avatar>
            </template>
          </v-list-item>
          <v-divider />
          <v-list-item href="#" title="Wallet Lorem" class="wallet-list">
            <template #prepend>
              <v-avatar>
                <img :src="imgAPI.logos[23]" alt="nft card">
              </v-avatar>
            </template>
          </v-list-item>
          <v-divider />
          <v-list-item href="#" title="Wallet Lorem" class="wallet-list">
            <template #prepend>
              <v-avatar>
                <img :src="imgAPI.logos[9]" alt="nft card">
              </v-avatar>
            </template>
          </v-list-item>
        </v-list>
                ...
                <ul>
                  <li>
                    <v-btn variant="text" size="small" class="btn">
                      <img :src="imgAPI.logos[1]" alt="wallet logo"> Wallet Lorem
                    </v-btn>
                  </li>
                  <li>
                    <v-btn variant="text" size="small" class="btn">
                      <img :src="imgAPI.logos[2]" alt="wallet logo"> Wallet Ipsum
                    </v-btn>
                  </li>
                  <li>
                    <v-btn variant="text" size="small" class="btn">
                      <img :src="imgAPI.logos[3]" alt="wallet logo"> Wallet Dolor
                    </v-btn>
                  </li>
                  <li>
                    <v-btn variant="text" size="small" class="btn">
                      <img :src="imgAPI.logos[11]" alt="wallet logo"> Wallet Sit Amet
                    </v-btn>
                  </li>
                  <li>
                    <v-btn
